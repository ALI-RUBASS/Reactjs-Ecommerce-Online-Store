...
const ProfilePage = () => {
    ...
    const cnic = localStorage.getItem('Acnic');
    const contact = localStorage.getItem('Acontact');
    const address = localStorage.getItem('Aaddress');
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="py-10">
                ...
                <h1 className="text-3xl font-bold bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 bg-clip-text text-transparent p-5 rounded-lg">{name} <b className="text-sm">✓</b></h1>
                    <button
                    onClick={() =>window.location.href = "/edit-admin"}
                    ...
                    <div className="mt-6 flex flex-col space-y-4">
                        ...
                        <div className="w-full">
                            <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                                <div className="px-4 py-5 sm:p-6">
                                    <h3 className="text-lg leading-6 font-medium text-gray-900">Admin ID</h3>
                                    <div className="mt-2 max-w-xl text-sm text-gray-500">{adminId}</div>
                                </div>
                            </div>
                        </div>
                    </div>
