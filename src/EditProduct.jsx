...
const EditProduct = () => {
    ...
    const Pvendorid = localStorage.getItem('Pvendorid');
    const Pname = localStorage.getItem('Pname');
    const Pdescription = localStorage.getItem('Pdescription');
    const Pcategory = localStorage.getItem('Pcategory');
    const Pbrand = localStorage.getItem('Pbrand');
    ...
    const handleSubmit = (e) => {
        ...
        fetch('http://localhost:5000/query', {
            ...
            body: JSON.stringify({
                query: "Update stock set name = '" + name + "', description = '" + description + "', brand = '" + brand + "', quantity = " + quantity + ", image = '" + picture + "', category = '" + category + "', price = " + price + " where productid = " + Pproductid + " AND vendorid = " + Pvendorid
            })
        })
