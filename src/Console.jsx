...
import Profile from './VendorProfile.jsx'
            ...
            <div className="flex flex-1">
                <aside className="bg-gray-200 w-64 hidden sm:block">
                    <nav className="mt-6">
                        ...
                        <button className="w-64" onClick={() => handleComponentChange("Order Requests")}>
                        <a
                        ...
                        <button className="w-64" onClick={() => handleComponentChange("Vendor Report")}>
                        <a
                            href="#"
                            className="flex items-center py-2 px-4 text-gray-600 hover:bg-blue-100 hover:text-blue-500"
                        >
